...
if(isset($_POST['upload_profile'])){   
   ...
   {    
    ...
    header("Location: ../public_html/view/party_form_pictures_background.html");
    exit();
   }
}
 if(isset($_POST['upload_background']))
      {   
        ...
        if(move_uploaded_file($file_loc,$file_path))
        {
          ...
          header("Location: ../public_html/view/party_date.php");
          exit();   
        }
        else
        {
          header("Location : ../public_html/party_form_pictures.html");
          exit(); 
        }
	    }
...
if(isset($_POST['user_upload_profile']))
  {     
      ...
      {
        header("Location : ../public_html/viw/main_panel.php");
        exit(); 
      }
	}
?>